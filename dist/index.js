...
import { Texture, Vector2, RawShaderMaterial, AdditiveBlending, Points, BufferGeometry, BufferAttribute, Color } from 'three';
...
function get_material(char_max) {
...
class PointTextHelper extends Points {
    ...
    set opacity(value) { this.material['uniforms'].opacity.value = value; }
}
